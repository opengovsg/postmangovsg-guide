...
* [🚀 How to send a campaign?](campaign-guide/quick-start/README.md)
  * [📧 Sending Email Campaigns](campaign-guide/quick-start/email/README.md)
...
* [🤖 Telegram Bot](campaign-guide/telegram-bot/README.md)
  * [Add Telegram Bot Token in Postman](campaign-guide/telegram-bot/add-telegram-bot-token-in-postman.md)
  * [Instructions for Recipient Onboarding](campaign-guide/telegram-bot/instructions-recipient-telegram.md)
  * [Use the Bot in the Campaign](campaign-guide/telegram-bot/use-the-bot-in-the-campaign.md)
  * [Telegram Formatting](campaign-guide/telegram-bot/telegram-formatting.md)
  * [Telegram Bot Statistics](campaign-guide/telegram-bot/telegram-bot-statistics.md)
